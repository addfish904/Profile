(function () {
    ...
    function animateStackCards() {
        ...
        for (var i = 0; i < this.items.length; i++) {
            ...
            // console.log(this.cardTop, top ,  this.cardHeight , this.marginY)
            if (scrolling > 0) {
  ...
  const sr = ScrollReveal({
    origin: 'bottom', // 動畫開始的方向 (可選: top, right, bottom, left)
    distance: '100px', // 元素移動的距離
    duration: 1000,   // 動畫持續時間 (以毫秒計算)
    delay: 100,       // 延遲時間
    reset: true       // 每次捲動時是否重新觸發動畫
  });
